...
let objFour = { a: [1,2], b: [2,4]}
let objFive = { b: [2,2], a: [1,2]}

// assertObjectsEqual(objOne, objTwo) //=>true
// assertObjectsEqual(objOne, objTwo) //=>true
// assertObjectsEqual(objOne, objThree) //=>>false
// assertObjectsEqual(objFour, objFive) //=>true
// assertObjectsEqual(objFive, objFour) //=>true
